...
export const EvidenceLocker: React.FC<EvidenceLockerProps> = ({ actionHistory }) => {
  ...
  return (
    <div className="shrink-0 max-h-[140px] bg-[#0c0c0e] border-b border-slate-800 relative overflow-hidden flex flex-col">
      ...
      <div className="pt-8 px-3 pb-3 h-full overflow-y-auto flex gap-2 flex-wrap items-start">
